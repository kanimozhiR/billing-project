...
def bill_generated
  ...
  private
    ...
    def invoice_params
      params.require(:invoice).permit(:customer_email, :customer_paid, invoice_details_attributes: [:id, :invoice_id,:product_id,:price,:quantity, :purchase_price, :item_tax, :tax_payable, :total_price])
    end
end
